...
def main(target: str) -> None:
    ...
    for existing, replacement in [
        (
            "https://img.shields.io/pypi/v/saldowsd.svg",
            f"https://img.shields.io/pypi/v/saldowsd/{version}.svg",
        ),
        # (
        #     "https://img.shields.io/pypi/l/saldowsd.svg",
        #     f"https://img.shields.io/pypi/l/saldowsd/{version}.svg",
        # ),
        (
            "https://img.shields.io/pypi/pyversions/saldowsd.svg",
            f"https://img.shields.io/pypi/pyversions/saldowsd/{version}.svg",
        ),
    ]:
    ...
    def replace(match: re.Match) -> str:
        ...
        if not url.startswith("http"):
            url = urllib.parse.urljoin(
                f"https://github.com/spraakbanken/saldowsd-rs/blob/{version}/README.md",
                url,
            )
        return f"]({url})"
